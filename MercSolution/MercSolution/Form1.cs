...
namespace MercSolution
{
    public partial class Form1 : Form
    {
        ...
        //Constructor posteos
        public Form1(string path, string pathA)
        {
            controlDeCasos = 1;
            pantallaCarga.Show();
        ...
        public Form1(string pathI, string pathE, string pathA)
        {
            controlDeCasos = 2;
            pantallaCarga.Show();
            pantallaCarga.aumentarCarga(10);
        ...
        public Form1(string pathE, string pathA, int a)
        {
            InitializeComponent();
            controlDeCasos = 3;
            pantallaCarga.Close();
        ...
        public void llenaPaquetes(string nombre)
        {
            ...
            destworkBook = excelApplication.Workbooks.Open(@"C:\Users\DAVIDGUTIERREZLOPEZ\Documents\Proyectos\MercSolutions\" + nombre + ".xlsx");
        ...
        private void Recalcular_Click(object sender, EventArgs e)
        {
            ...
            if (controlDeCasos == 1)
            {
                Form1 form1 = new Form1(path, pathA);
                form1.Show();
            }
            else if (controlDeCasos == 2)
            {
                Form1 form1 = new Form1(pathV, path, pathA);
                form1.Show();
            }
            else
            {
                Form1 form1 = new Form1(pathV, path, 1);
                form1.Show();
            }
