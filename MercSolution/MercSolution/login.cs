        ...
        private void aceptar_Click(object sender, EventArgs e)
        {
            ...
            if (pathA != null && acceso){
                ...
                if (checkBox2.Checked && !checkBox3.Checked)
                {
                    ...
                    {
                        this.Hide();
                        Form1 form1 = new Form1(pathE, pathA);
                ...
                if (!checkBox2.Checked && checkBox3.Checked)
                {
                    ...
                    {
                        this.Hide();
                        Form1 form1 = new Form1(pathEI, pathA, 1);
                        form1.Show();
                ...
                if (checkBox2.Checked && checkBox3.Checked)
                {
                    ...
                    {
                        this.Hide();
                        Form1 form1 = new Form1(pathE, pathEI, pathA);
                        form1.Show();
            ...
            {
                if(pathA == null && pathE == null && aprovado) { 
                    MessageBox.Show("Debe seleccionar Acces");
